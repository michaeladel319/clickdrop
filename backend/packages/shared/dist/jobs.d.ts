import type { AudioFormat, AudioQuality, MediaKind, VideoFormat, VideoQuality } from "./media";
import type { Platform } from "./platforms";
export declare const JOB_STATUSES: readonly ["QUEUED", "FETCHING_INFO", "DOWNLOADING", "CONVERTING", "COMPLETED", "FAILED", "CANCELLED", "EXPIRED"];
